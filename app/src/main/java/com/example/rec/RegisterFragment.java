...
public class RegisterFragment extends Fragment {
    ...
    private EditText nombre, email, password, confirmPassword;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nombre = v.findViewById(R.id.frg_register_txt_nombre);
        email = v.findViewById(R.id.frg_register_txt_email);
        password = v.findViewById(R.id.frg_register_txt_Password);
        confirmPassword = v.findViewById(R.id.frg_register_txt_RepitePass);
        {

        };

        Button btnSignIn = v.findViewById(R.id.frg_register_btn_entrar);
    ...
    private void registroUser(){
        ...
        String error2 = getString(R.string.contraseña_corta);
        Toast toast = Toast.makeText(getContext(), error,Toast.LENGTH_SHORT);
        Toast toast1 = Toast.makeText(getContext(), error2,Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.TOP,0,0);

        final String compruebaUser = nombre.getText().toString();
